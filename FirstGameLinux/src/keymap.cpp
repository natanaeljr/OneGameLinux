...
static firstgame::input::KeyAction MapGlfwKeyActionToGameKeyAction(int glfw_key_action)
{
    using firstgame::input::KeyAction;
...
static firstgame::input::Key MapGlfwKeyToGameKey(int glfw_key)
{
    using firstgame::input::Key;
    switch (glfw_key) {
...
firstgame::event::KeyEvent MapGlfwKeyEventToGameKeyEvent(int key, int scancode, int action,
                                                         int mods)
{
    return firstgame::event::KeyEvent{
        .key = MapGlfwKeyToGameKey(key),
        .action = MapGlfwKeyActionToGameKeyAction(action),
    };
}
